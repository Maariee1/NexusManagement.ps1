...
function CreateSplitWindow {
    ...
    $grid.RowDefinitions.Add((New-Object System.Windows.Controls.RowDefinition -Property @{ Height = "Auto" }))  # Split File Size
    ...
    $grid.ColumnDefinitions.Add((New-Object System.Windows.Controls.ColumnDefinition -Property @{ Width = "*" }))   # Textboxes fill remaining space
    $grid.ColumnDefinitions.Add((New-Object System.Windows.Controls.ColumnDefinition -Property @{ Width = "Auto" })) # Extra Controls (e.g., dropdown)
    ...
    $grid.Children.Add($splitSizeBox)
...
function HandleButtonClick {
    ...
    switch ($Action) {
        "Split" { CreateSplitWindow }
        "Join" { CreateJoinWindow }
        "Encrypt" { [System.Windows.MessageBox]::Show("Encrypt functionality coming soon!") }
        "Decrypt" { [System.Windows.MessageBox]::Show("Decrypt functionality coming soon!") }
        "Exit" { $window.Close() }
    }
}
